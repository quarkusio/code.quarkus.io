  ...
  return (
    ...
    >
      <TextContent>
        ...
        You can follow the&nbsp;<ExternalLink href="https://quarkus.io/guides/" aria-label="Start playing with Quarkus">Quarkus guides</ExternalLink> <br />to learn more and build a great Quarkus app!
        </Text>
      </TextContent>
    </FixedModal>
  );
