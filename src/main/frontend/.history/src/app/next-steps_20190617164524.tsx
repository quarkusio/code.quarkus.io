  ...
  return (
    ...
    >
      <TextContent>
        ...
        <Text component={TextVariants.p}>
        Unzip the project and start playing with Quarkus. You can follow the <ExternalLink href="https://quarkus.io/guides/" aria-label="Start playing with Quarkus">Quarkus guides</ExternalLink> to learn more and build a great Quarkus app!
        </Text>
      </TextContent>
    </FixedModal>
  );
