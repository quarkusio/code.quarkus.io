...
function peg$parse(input, options) {
  ...
  function peg$f3(negated, field, values) {
    if (values[0] === '!') {
      values = ['*'];
      negated = '-';
    }
  ...
  function peg$parseSearch() {
    ...
    s0 = peg$currPos;
    s1 = peg$parse_();
    s2 = peg$parseTermOrFilter();
    if (s2 !== peg$FAILED) {
      s3 = [];
      s4 = peg$currPos;
      s5 = peg$parse_();
      s6 = peg$parseTermOrFilter();
      if (s6 !== peg$FAILED) {
        s5 = [s5, s6];
        s4 = s5;
      } else {
  ...
  function peg$parseTermOrFilter() {
    let s0;

    s0 = peg$parseInFilter();
    if (s0 === peg$FAILED) {
      s0 = peg$parseEqFilter();
      if (s0 === peg$FAILED) {
        s0 = peg$parsePlainTerm();
        if (s0 === peg$FAILED) {
          s0 = peg$parseNeqShortFilter();
        }
      }
    }
  ...
  function peg$parseNeqShortFilter() {
    let s0, s1, s2;
